...
$(document).ready(function () {
    ...
    $.post("controlador/consultas/json_buscar.php", {
        ...
        $.each(JSON.parse(dato), function (idx, obj) {
            ...
            if (foto == "") {
                ...
                $("#i_imagen_1").attr("src", direccion_imagen);
                $("#i_file_1").val("");
            ...
            if (croquis == "") {
                ...
                $("#i_imagen_2").attr("src", direccion_imagen);
                $("#i_file_2").val("");
            ...
            if (curriculum == "") {
                ...
                var direccion_imagen = "../../paquetes/imagenes/archivos_alumno/" + curriculum;
                $("#i_nombre_cv").val(curriculum);
                $("#i_file_3").val("");
    ...
    $.post("controlador/consultas/obtener_hijos.php", {id: get_id}, function (data) {
        var dato = $.trim(data);
        var nFilas = $("#tbl_lista_agregar .ai_fila").length;
        if (nFilas == 0) {
            $("#tbl_lista_agregar tbody").html(dato);
        } else {
