...
<!--        <script src="../../paquetes/sweet_alert/sweetalert.min.js"></script>
        ...
        <script src="js/funciones_reporte.js" ></script>
...
<!--<input type="hidden" id="get_nombre_instituto"/>-->
        <div class="contenedor">
            <center><img class="img-thumbnail" id="i_imagen_1_1"  style="width: 90px !important;height: 120px !important;border: 1px solid silver"/></center>
            <br>
            <div class="panel panel-info">
                <div class="panel-heading">
                    <center><strong class="titulo_panel">REGISTRO DE DATOS PERSONALES </strong></center>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="tbl_lista_agregar" class="table table-striped table-condensed table-hover table-bordered" >
                                ...
                                <tbody>
                                    <tr>
                                        <td class='text-center' colspan='5'>Ningun hijo agregado</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="panel panel-info div_croquis">
                <div class="panel-heading">
                    <strong class="titulo_panel">CROQUIS DE UBICACION AVENIDAS O PUNTOS CONSPICUOS  RESALTANTES EN LA CERCANIA A SU DOMICILIO</strong>
                </div>
                <div class="panel-body">
                    <center>
                        <img class="img-thumbnail" id="i_imagen_2_2" style="width: 800px !important;height: 400px !important;border: 1px solid silver"/>
                    </center>
                </div>
            </div>
<!--            <div class="row">
