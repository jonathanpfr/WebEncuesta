...
$(document).ready(function () {
    ...
    $.post("controlador/consultas/json_buscar.php", {
        ...
        $.each(JSON.parse(dato), function (idx, obj) {
            ...
            $("#i_nro_cip").val(obj.V010NRO_CIP);
            $("#i_dni").val(obj.V010DNI);
            $("#i_apellido_paterno").val(obj.V010APELLIDO_PATERNO);
            $("#i_apellido_materno").val(obj.V010APELLIDO_MATERNO);
            $("#i_nombres").val(obj.V010NOMBRES);
            $("#i_fecha_nacimiento").val(obj.F010FECHA_NACIMIENTO);
            $("#i_universidad_instituto").val(obj.V010UNIVERIDAD);
            $("#i_calle_av_jr_domicilio").val(obj.V010CALLE_JR);
            $("#i_urbanizacion").val(obj.V010URBANIZACION);
            $("#i_distrito_domicilio").val(obj.V010DISTRITO);
            $("#i_idiomas_domina").val(obj.V010IDIOMAS_DOMINA);
            //$("#i_denominacion_religion").val(obj.);
            $("#i_telefono").val(obj.V010TELEFONO);
            $("#i_mail").val(obj.V010MAIL);
            $("#i_fecha_ingreso_marina").val(obj.F010FECHA_INGRESO_MARINA);
            $("#i_fecha_ultimo_ascenso_grado_actual").val(obj.F010FECHA_ASENSO_GRADO);
            $("#i_nro_brevete").val(obj.V010NRO_BREVETE);
            $("#i_modelo_vehiculo").val(obj.V010MODELO_VEHICULO);
            $("#i_placa_nro").val(obj.V010PLACA_NRO);
            $("#i_nro_lic_arma").val(obj.V010NRO_LIC_ARMA);
            $("#i_modelo_arma").val(obj.V010MODELO_ARMA);
            $("#i_tipo_arma").val(obj.V010TIPO_ARMA);
            $("#i_marca_arma").val(obj.V010MARCA);
            $("#i_calibre_arma").val(obj.V010CALIBRE);
            $("#i_curso_seguir_dictar").val(obj.V010CURSO_SEGUIR_DICTAR);
            $("#i_dependencia_origen_destaque").val(obj.V010DEPENDENCIA_ORIGEN);
            $("#i_nro_carta_referencia").val(obj.V010NRO_CARTA_REFERENCIA);
            $("#i_cargo_ocupaba_dependencia").val(obj.V010CARGO_OCUPA);
            $("#i_chofer_emergencia").val(obj.V010PROFESION_EMERGENCIA);
            $("#i_brevete_militar_emergencia").val(obj.V010BREVETE_MILITAR_EMERGENCIA);
            $("#i_puesto_zafarrancho_emergencia").val(obj.V010PUESTO_ZAFARRANCHO);
            $("#i_emergencia_llamar_a").val(obj.V010EMERGENCIA_LLAMAR_A);
            $("#i_emergencia_parentesco").val(obj.V010EMERGENCIA_PARENTESCO);
            $("#i_emergencia_parentesco_telefono").val(obj.V010EMERGENCIA_TELEFONO);
            $("#i_emergencia_parentesco_centro_trabajo").val(obj.V010EMERGENCIA_CENTRO_TRABAJO);
            $("#i_emergencia_parentesco_domicilio").val(obj.V010EMERGENCIA_DOMICILIO);

            $("#i_nombre_padre").val(obj.V010NOMBRE_PADRE);
            $("#i_ocupacion_padre").val(obj.V010OCUPACION_PADRE);
            $("#i_domicilio_padre").val(obj.V010DOMICILIO_PADRE);
            $("#i_telefono_padre").val(obj.V010TELEFONO_PADRE);

            $("#i_nombre_madre").val(obj.V010NOMBRE_MADRE);
            $("#i_ocupacion_madre").val(obj.V010OCUPACION_MADRE);
            $("#i_domicilio_madre").val(obj.V010DOMICILIO_MADRE);
            $("#i_telefono_madre").val(obj.V010TELEFONO_MADRE);
            //**************************************
            $("#i_nacionalidad_esposa").val(obj.V010NACIONALIDAD_ESPOSA);
            $("#i_nombres_apellidos_esposa").val(obj.V010NOMBRE_APELLIDOS_ESPOSA);
            $("#i_fecha_nacimiento_esposa").val(obj.F010FECHA_NACIMIENTO_ESPOSA);
            $("#i_dpto_esposa").val(obj.V010DPTO_ESPOSA);
            $("#i_centro_labores_esposa").val(obj.V010CENTRO_LABORES_ESPOSA);
            $("#i_cargo_grado_profesion_esposa").val(obj.V010CARGO_GRADO_ESPOSA);
            $("#i_domicilio_esposa").val(obj.V010DOMICILIO_ESPOSA);
            $("#i_telefono_esposa").val(obj.V010TELEFONO_ESPOSA);
            //********** combos de si o no *************
            $("#i_liper").html("<option value='0'>--SELECCIONE--</option><option value='1'>SI</option><option value='2'>NO</option>");
            $("#i_liper option[value='" + obj.I010LIPER + "']").attr('selected', 'selected');

            $("#i_lisan").html("<option value='0'>--SELECCIONE--</option><option value='1'>SI</option><option value='2'>NO</option>");
            $("#i_lisan option[value='" + obj.I010LISAN + "']").attr('selected', 'selected');

            $("#i_tin").html("<option value='0'>--SELECCIONE--</option><option value='1'>SI</option><option value='2'>NO</option>");
            $("#i_tin option[value='" + obj.I010TIN + "']").attr('selected', 'selected');

            $("#i_vive_padre").html("<option value='0'>--SELECCIONE--</option><option value='1'>SI</option><option value='2'>NO</option>");
            $("#i_vive_padre option[value='" + obj.I010PADRE_VIVE + "']").attr('selected', 'selected');

            $("#i_vive_madre").html("<option value='0'>--SELECCIONE--</option><option value='1'>SI</option><option value='2'>NO</option>");
            $("#i_vive_madre option[value='" + obj.I010MADRE_VIVE + "']").attr('selected', 'selected');

            $("#i_matrimonio_civil_esposa").html("<option value='0'>--SELECCIONE--</option><option value='1'>SI</option><option value='2'>NO</option>");
            $("#i_matrimonio_civil_esposa option[value='" + obj.I010MATRIMONIO_CIVIL_ESPOSA + "']").attr('selected', 'selected');

            $("#i_matrimonio_religioso_esposa").html("<option value='0'>--SELECCIONE--</option><option value='1'>SI</option><option value='2'>NO</option>");
            $("#i_matrimonio_religioso_esposa option[value='" + obj.I010MATRIMONIO_RELIGIOSO_ESPOSA + "']").attr('selected', 'selected');

            $.post("controlador/consultas/combo_compromiso_esposa.php", function (data) {
                var dato = $.trim(data);
                $("#i_tipo_compromiso_esposa").html(dato);
                $("#i_tipo_compromiso_esposa option[value='" + obj.I010MATRIMONIO_RELIGIOSO_ESPOSA + "']").attr('selected', 'selected');

                $.post("controlador/consultas/combo_condicion_llega.php", function (data) {
                    var dato = $.trim(data);
                    $("#i_condicion_llega").html(dato);
                    $("#i_condicion_llega option[value='" + obj.I012ID_TIPO_CONDICION_LLEGA + "']").attr('selected', 'selected');

                    $.post("controlador/consultas/combo_departamento.php", function (data) {
                        var dato = $.trim(data);
                        $("#i_departamento_nacimiento").html(dato);
                        $("#i_departamento_nacimiento option[value='" + obj.I004ID_DEPARTAMENTO + "']").attr('selected', 'selected');

                        $.post("controlador/consultas/combo_provincia.php", {id_detapartamento: obj.I004ID_DEPARTAMENTO}, function (data) {
                            var dato = $.trim(data);
                            $("#i_provincia_nacimiento").html(dato);
                            $("#i_provincia_nacimiento option[value='" + obj.I005ID_PROVINCIA + "']").attr('selected', 'selected');

                            $.post("controlador/consultas/combo_distrito.php", {id_provincia: obj.I005ID_PROVINCIA}, function (data) {
                                var dato = $.trim(data);
                                $("#i_distrito_nacimiento").html(dato);
                                $("#i_distrito_nacimiento option[value='" + obj.I006ID_DISTRITO + "']").attr('selected', 'selected');

                                $.post("controlador/consultas/combo_especialidad.php", function (data) {
                                    var dato = $.trim(data);
                                    $("#i_especialidad").html(dato);
                                    $("#i_especialidad option[value='" + obj.I002ID_ESPECIALIDAD + "']").attr('selected', 'selected');

                                    $.post("controlador/consultas/combo_estado_civil.php", function (data) {
                                        var dato = $.trim(data);
                                        $("#i_estado_civil").html(dato);
                                        $("#i_estado_civil option[value='" + obj.I009ID_ESTADO_CIVIL + "']").attr('selected', 'selected');

                                        $.post("controlador/consultas/combo_grado_catrgoria.php", function (data) {
                                            var dato = $.trim(data);
                                            $("#i_grado_categoria").html(dato);
                                            $("#i_grado_categoria option[value='" + obj.I001ID_GRADO_CATEGORIA + "']").attr('selected', 'selected');

                                            $.post("controlador/consultas/combo_grado_instruccion.php", function (data) {
                                                var dato = $.trim(data);
                                                $("#i_grado_instruccion").html(dato);
                                                $("#i_grado_instruccion option[value='" + obj.I007ID_GRADO_INSTRUCCION + "']").attr('selected', 'selected');

                                                $.post("controlador/consultas/combo_grupo_sanguineo.php", function (data) {
                                                    var dato = $.trim(data);
                                                    $("#i_grupo_sanguineo").html(dato);
                                                    $("#i_grupo_sanguineo option[value='" + obj.I003ID_GRUPO_SANGUINEO + "']").attr('selected', 'selected');

                                                    $.post("controlador/consultas/combo_religion.php", function (data) {
                                                        var dato = $.trim(data);
                                                        $("#i_religion").html(dato);
                                                        $("#i_religion option[value='" + obj.I008ID_RELIGION + "']").attr('selected', 'selected');
                                                        $.post("controlador/consultas/combo_tipo_condicion_llega.php", function (data) {
                                                            var dato = $.trim(data);
                                                            $("#i_condicion_llega").html(dato);
                                                            $("#i_condicion_llega option[value='" + obj.I012ID_TIPO_CONDICION_LLEGA + "']").attr('selected', 'selected');
                                                            $.post("controlador/consultas/combo_tipo_vivienda.php", function (data) {
                                                                var dato = $.trim(data);
                                                                $("#i_tipo_vivienda").html(dato);
                                                                $("#i_tipo_vivienda option[value='" + obj.I011ID_TIPO_VIVIENDA + "']").attr('selected', 'selected');

                                                                var foto = obj.T010FOTO;
                                                                var croquis = obj.T010CROQUIS;
                                                                var curriculum = obj.T010CURRICULUM;

                                                                $("#m_cambio_1").val("0");
                                                                $("#m_cambio_2").val("0");
                                                                $("#m_cambio_3").val("0");
                                                                $("#back_imagen_1").val(foto);
                                                                $("#back_imagen_2").val(croquis);
                                                                $("#back_imagen_3").val(curriculum);

                                                                if (foto == "") {
                                                                    var direccion_imagen = "../../paquetes/imagenes/archivos_alumno/" + croquis;
                                                                    $("#i_imagen_2_2").attr("src", direccion_imagen);
                                                                    $.post("controlador/consultas/obtener_hijos_reporte.php", {id: get_id}, function (data) {
                                                                        var dato = $.trim(data);
                                                                        var nFilas = $("#tbl_lista_agregar .ai_fila").length;
                                                                        if (nFilas == 0) {
                                                                            $("#tbl_lista_agregar tbody").html("<tr><td class='text-center' colspan='5'>Ningun hijo agregado</td></tr>");
                                                                        } else {
                                                                            $("#tbl_lista_agregar tbody").append(dato);
                                                                        }
                                                                        evento_tabla();
                                                                        $("#contenedor input").prop("disabled", true);
                                                                        $("#contenedor select").prop("disabled", true);
                                                                        $("#contenedor file").prop("disabled", true);
                                                                        $("#i_imagen_1_1").hide();
                                                                    ...
                                                                    $.post("controlador/consultas/obtener_hijos_reporte.php", {id: get_id}, function (data) {
                                                                        ...
                                                                        var direccion_imagen = "../../paquetes/imagenes/archivos_alumno/" + foto;
                                                                        $("#i_imagen_1_1").attr("src", direccion_imagen);
                                                                        if (croquis == "") {
                                                                            $(".div_croquis").hide();
                                                                            setTimeout(imprimir, 2000);
                                                                        } else {
    ...
    $("#btn_registrar").click(function () {
        ...
        var m_cambio_1 = $("#m_cambio_1").val();//0 sin pulsar,1=pulsado
        var m_cambio_2 = $("#m_cambio_2").val();//0 sin pulsar,1=pulsado
        var m_cambio_3 = $("#m_cambio_3").val();//0 sin pulsar,1=pulsado

        var back_imagen_1 = $("#back_imagen_1").val();
        var back_imagen_2 = $("#back_imagen_2").val();
        var back_imagen_3 = $("#back_imagen_3").val();
...
//******************************************************************************
        ...
        var detalle_tabla_eliminar = [];
        $("#tb_eliminar_detalle .e_fila").each(function (index, value) {
            var id_eliminar = $(this).find(".id_eliminar").val();
            detalle_tabla_eliminar.push({
                id_eliminar: id_eliminar
            });
        });
        detalle_tabla_eliminar = JSON.stringify(detalle_tabla_eliminar);
        ...
        formData.append('detalle_tabla_eliminar', detalle_tabla_eliminar);

        formData.append('m_cambio_1', m_cambio_1);
        formData.append('m_cambio_2', m_cambio_2);
        formData.append('m_cambio_3', m_cambio_3);

        formData.append('back_imagen_1', back_imagen_1);
        formData.append('back_imagen_2', back_imagen_2);
        formData.append('back_imagen_3', back_imagen_3);

        formData.append('get_id', get_id);


        //verificar que el usuario sea unico
        $.post("controlador/consultas/verificar_modificar.php", {
            dni: i_dni, get_id: get_id
        }, function (data) {
            var dato = $.trim(data);
            if (dato == "0") {
                $.ajax({
